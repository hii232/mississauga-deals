  ...
  return (
    <div className="relative" ref={ref}>
      <button
        ...
        className="flex flex-shrink-0 items-center gap-1.5 whitespace-nowrap rounded-lg border border-accent/30 bg-accent/5 px-3 py-2 text-sm font-medium text-accent hover:bg-accent/10 hover:border-accent/50 transition-all"
      >
