...
/**
 * Place name -> URL path segment. "Halton Hills" -> "halton-hills".
 *
 * Single source of truth for BOTH the /gta/[city] and /neighbourhoods/[slug]
 * routes, which had identical private copies of this. The two must agree with
 * each other and with every link pointing at them — a drift here silently
 * produces 404s on statically generated pages, since both routes build their
 * generateStaticParams list from this same transform.
 */
export function slugifyPlace(name) {
