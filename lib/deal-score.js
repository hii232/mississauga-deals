 ...
 */
export function calculateDealScore({ cashFlow, dom, priceDrop, capRate, basementTier, hasSuite, transitScore, schoolScore }) {
  ...
  // Market score: basement + transit + school
  // Base 4 (lowered from 5 to accommodate transit/school bonuses)
