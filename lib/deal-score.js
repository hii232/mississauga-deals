...
// Tiered basement detection keywords
const LEGAL_SUITE_KEYWORDS = /\b(legal basement|basement apt|in-law suite|in-law unit|accessory unit|accessory apartment|duplex|two unit|2 unit|rental income|income potential|income suite|2nd kitchen|second kitchen|registered suite|legal suite)\b/i;
const SEPARATE_ENTRANCE_KEYWORDS = /\b(separate entrance|side entrance|private entrance|own entrance|sep entrance|sep\.? ent)\b/i;
const FINISHED_BASEMENT_KEYWORDS = /\b(finished basement|fin\.? bsmt|fully finished basement|professionally finished basement)\b/i;
