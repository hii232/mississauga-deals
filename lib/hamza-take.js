...
export function generateHamzaTake(l) {
  ...
  if (basementTier === 'legal') {
    ...
    parts.push(
      `Finished basement noted but no separate entrance — not immediately rentable as a suite, but it's a value-add opportunity. Adding a separate entrance and legalizing it could unlock $900-1,200/mo in basement income.`
    );
  }
