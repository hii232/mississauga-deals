 ...
 */
export function calcMonthly(price, downPct = 20, rate = 4.5, years = 25) {
 ...
 */
export function calculateCashFlow(price, rent, downPct = 20, rate = 4.5, amortYears = 25, city = null) {
