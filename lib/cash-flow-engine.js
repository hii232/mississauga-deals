...
/**
 * Estimate monthly rent based on price, beds, city, and type
 */
export function estimateRent(price, beds, city, type) {
 ...
 */
export function calculateCashFlow(price, rent, downPct = 20, rate = 5.5, amortYears = 25) {
