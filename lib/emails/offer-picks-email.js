...
<table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
  ...
  <tr><td style="padding:0 2px 18px;">
    ...
    <div style="font-family:${SANS};font-size:16px;color:${INK};line-height:1.65;margin-top:12px;">
      ...
      has an actual reason to negotiate &mdash; they&rsquo;ve been sitting, or the price has
    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="border:1px dashed ${LINE};border-radius:12px;">
      <tr><td style="padding:16px 18px;">
        ...
        <div style="font-family:${SANS};font-size:14px;color:${MUTED};line-height:1.7;margin-top:8px;">
          ...
          &mdash; the sale-to-list ratio in the TRREB Market Watch report for ${esc(month)} &mdash;
  ...
  <tr><td style="padding:22px 2px 0;">
    <div style="font-family:${SANS};font-size:16px;color:${INK};line-height:1.7;">
      If you want this for your budget instead of mine &mdash; <strong>just reply with a price range
  ...
  <tr><td style="padding:24px 2px 0;">
    <div style="font-family:${SANS};font-size:16px;color:${INK};line-height:1.6;">&mdash; Hamza</div>
  ...
  <tr><td style="padding:18px 2px 8px;">
    <div style="border-top:1px solid #CBD5E1;padding-top:14px;">
      <div style="font-family:${SANS};font-size:11px;line-height:1.65;color:#7A879B;">
        ...
        Listing details, asking prices and days-on-market are drawn from live MLS data at the time of sending and change daily &mdash; a property may be sold or withdrawn by the time you read this. Suggested opening offers are one agent&rsquo;s opinion of a negotiating position based on TRREB sale-to-list data for ${esc(month)}; they are not appraisals, valuations, or a representation of market value, and they are not investment advice. Listing data &copy; TRREB, deemed reliable but not guaranteed.
      </div>
