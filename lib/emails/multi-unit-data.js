...
// Re-exported from the canonical type list so the email, the site filter and
// the feed mapper can never disagree about what counts as multi-unit.
import { MULTI_UNIT } from '../property-types.js';
export const MULTI_UNIT_TYPES = MULTI_UNIT;
