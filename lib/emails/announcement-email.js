 ...
 */
export function buildAnnouncementEmail({ email, name, posts } = {}) {
...
<table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
  ...
  <tr><td style="padding:18px 8px 4px;">
    <table cellpadding="0" cellspacing="0"><tr>
      <td width="60" valign="top" style="padding-right:13px;">
        <div style="width:50px;height:50px;line-height:50px;text-align:center;background:${NAVY};border-radius:50%;font-family:${SANS};font-size:18px;font-weight:800;color:${GOLD};">HN</div>
      </td>
      <td valign="middle">
