...
//   • Every number is one the live site already publishes (
  ...
  <tr><td style="padding:12px 0 2px;">
    <table width="100%" cellpadding="0" cellspacing="0"><tr>
      <td bgcolor="${WHITE}" style="background:${WHITE};border:1px solid ${LINE};border-radius:12px;padding:14px 18px;box-shadow:${SHADOW};" align="center">
        <span style="font-family:${SANS};font-size:13px;font-weight:700;color:${INK};white-space:nowrap;"><span style="color:${GOLD};">&#9733;&#9733;&#9733;&#9733;&#9733;</span> Verified Google reviews</span>
