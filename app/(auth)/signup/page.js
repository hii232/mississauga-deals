...
export default function SignupPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      // rate-limited, etc.). Without this guard the client used to mark the
      // visitor "registered" and redirect anyway — silently losing the highest-
      // value lead (name + email + phone + CASL consent). Surface the real error.
      if (!res.ok) {
