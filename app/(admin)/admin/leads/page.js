...
function sourceLabel(src) {
  const map = { registration: 'Sign Up', quiz: 'Quiz', 'google-signin': 'Google', 'deal-alert': 'Alert', 'exit-intent': 'Exit Intent', 'saved-search': 'Saved Search', viewing: '🏠 Viewing', booking: 'Booked Call', 'precon-vip': 'Pre-Con VIP', newsletter: 'Newsletter', 'seller-valuation': '🏡 Seller' };
...
const SOURCES = ['All', 'viewing', 'booking', 'seller-valuation', 'registration', 'quiz', 'google-signin', 'deal-alert', 'precon-vip', 'exit-intent', 'saved-search'];
