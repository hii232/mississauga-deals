...
- 2026-07-20 — [seo agent] BreadcrumbList JSON-LD added to listing detail + blog post pages (highest-traffic page types; only neighbourhoods/about had it — blog even showed a visible breadcrumb with no schema) — (this commit)
