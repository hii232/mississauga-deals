...
- 2026-07-20 — [improvement agent] Fixed dead-end "Sign Up Free" CTAs in InlineCTA: alerts variant pointed to /quiz and newsletter variant to /listings — neither has a signup form; both now go to /alerts (real name+email capture). Verified cap-rate/CoC/LTT engine guards divide-by-zero and Ontario LTT brackets are correct — (this commit)
