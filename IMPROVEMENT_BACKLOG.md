...
- 2026-07-20 — [design agent] Listing detail had NO lead CTA: added mobile sticky "Book a Viewing" bar (+ tap-to-call) and desktop CTA pair beside the price → /book-call?listing={id}. Needs a production eyeball once shipped (no listing data available locally) — (this commit)
