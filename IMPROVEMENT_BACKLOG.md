...
- 2026-07-20 — [seo agent] HST-rebate landing page (high search volume: "HST rebate new homes Ontario"): added FAQPage JSON-LD (5 Q&As mirroring on-page content — savings tiers, eligibility, dates, resale exclusion, property types) + BreadcrumbList. Page previously had zero structured data — (this commit)
